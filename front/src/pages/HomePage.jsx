        ...
        <div className="w-[92%] sm:w-[95%] max-w-6xl mx-auto flex flex-wrap justify-center gap-2.5">
          {pagesExistantes.map((page, index) => (
            <Link
              key={page.to}
              to={page.to}
              className="w-full sm:w-[220px] inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-[#1f2a2e] text-white font-semibold border border-white/20 hover:bg-[#26343a] transition-colors duration-200 home-hero-enter"
